...
namespace cheat::imgui
{
    namespace g
    {
        ...
        static inline WNDCLASSEXW overlayWndClass;
    ...
    inline void init()
    {
        g::overlayWndClass = WNDCLASSEXW{
            sizeof(g::overlayWndClass),
        ...
        {
            CleanupDeviceD3D();
            UnregisterClassW(g::overlayWndClass.lpszClassName, g::overlayWndClass.hInstance);
            return;
        }
